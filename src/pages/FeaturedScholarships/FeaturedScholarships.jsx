...
import { FaCalendarAlt, FaDollarSign, FaArrowRight, FaArrowLeft } from "react-icons/fa";
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
        <div>
          <h2 className="text-5xl font-extrabold text-slate-900 tracking-tight">
            Featured <span className="font-light text-slate-600">Scholarships</span>
          </h2>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 h-full flex flex-col group hover:shadow-2xl transition-all duration-500">
              ...
              <div className="flex justify-between items-center mb-8 bg-slate-50 p-4 rounded-2xl">
                <div>
                  ...
                  <p className="text-2xl font-black text-slate-900">${sch.applicationFees || '5,000'}</p>
                </div>
              ...
              <p className="text-slate-500 text-sm mb-6 line-clamp-3">
                Join {sch.universityName} in {sch.universityCountry}. This {sch.scholarshipCategory} program is a great opportunity for {sch.subjectCategory} aspirants.
              </p>

              {/* Tags */}
              <div className="flex flex-wrap gap-2 mb-8 mt-auto">
                <span className="bg-emerald-50 text-emerald-700 text-[10px] font-bold px-3 py-1 rounded-lg uppercase">{sch.scholarshipCategory}</span>
                <span className="bg-blue-50 text-blue-700 text-[10px] font-bold px-3 py-1 rounded-lg uppercase">{sch.degree}</span>
              </div>
