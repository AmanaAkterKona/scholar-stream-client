...
import useTheme from "../../Shared/useTheme"; // পাথটি চেক করে নিও
...
const HowItWorks = () => {
  ...
  return (
    <section className="relative py-28 overflow-hidden group">
      {/* Background - Light/Dark consistency maintained via overlay */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            <motion.div
              ...
              className={`h-full backdrop-blur-xl rounded-[40px] p-10 border transition-all duration-700 ${
