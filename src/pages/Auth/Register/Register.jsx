  ...
  const handleRegistration = async (data) => {
    ...
    try {
      ...
      console.log(
        ...
        profileImg.name,
        "-",
        (profileImg.size / 1024).toFixed(2),
        "KB"
      );
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full h-full p-12 text-white">
          ...
          <div className="space-y-4 w-full max-w-md">
            <div className="backdrop-blur-xl bg-white/10 p-5 rounded-2xl border border-white/20 shadow-lg hover:bg-white/15 transition-all">
              <h3 className="text-xl font-bold text-[#37c4ef] mb-2">
                🚀 Quick Start
              </h3>
            ...
            <div className="backdrop-blur-xl bg-white/10 p-5 rounded-2xl border border-white/20 shadow-lg hover:bg-white/15 transition-all">
              ...
              <p className="text-sm text-white/80">
                Get scholarships tailored to your profile
              </p>
            </div>
      ...
      <div className="flex w-full md:w-1/2 justify-center items-center p-8 relative overflow-hidden">
        ...
        >
          ...
          <div className="text-center mb-6">
            <h2 className="text-4xl font-bold text-white mb-2 drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
              Join Us Today
            </h2>
          ...
          {/* Name */}
          <div className="mb-4">
            <label className="block mb-2 font-bold text-white text-sm uppercase tracking-wider">
              Name
            </label>
            <input
              type="text"
          ...
          {/* Photo */}
          <div className="mb-4">
            <label className="block mb-2 font-semibold text-white/90 text-sm uppercase tracking-wider">
              Photo
            </label>
            <input
              type="file"
            ...
            />
            {errors.photo && (
              <p className="text-[#37c4ef] mt-2 text-sm font-medium">
                ⚠ Photo is required
              </p>
            )}
          </div>
